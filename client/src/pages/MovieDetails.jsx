...
const handleFavorite = async () => {
  try {
    if(!user) return toast.error("Please login to add favorite");
...
useEffect(()=>{
  ...
  return show ? (
    ...
    <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
      ...
      <div className='relative flex flex-col gap-3'>
        ...
        <div className='flex items-center flex-wrap gap-4 mt-4'>
          ...
          <a href='#dateSelect' className='px-10 py-3 text-sm bg-gray-800 hover:bg-amber-300-dull transition rounded-md font-medium cursor-pointer active:scale-95'>Buy Tickets</a>
    ...
    <p className='text-lg font-medium mt-20'>Your Favorite Hero</p>  
