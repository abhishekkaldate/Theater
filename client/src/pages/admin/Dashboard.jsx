      ...
      <p className='mt-10 text-lg font-medium'>Active Shows</p>
            <div className='relative flex flex-wrap gap-6 mt-4 max-w-5xl'>
              ...
              {dashboardData.activeShows.map((show)=>(
                <div key={show._id} className='w-55 rounded-lg overflow-hidden h-full pb-3 bg-amber-200/10 border-amber-200 hover:-translate-y-1 transition duration-300'>
                  <img src={image_base_url + show.movie.poster_path} alt='' className='h-60 w-full object-cover' />
                  <p className='font-medium p-2 truncate'>{show.movie.title}</p>
                  <div className='flex items-center justify-between px-2'>
                    <p className='text-lg font-medium'>{currency} {show.showPrice}</p>
                    <p>
                      <StarIcon className='w-4 h-4 text-amber-300 fill-amber-500'/>
...
//               bg-gray-400/10 border border-gray-200/20 rounded-md 
//               max-w-50 w-full"
//             >
//               <div>
//                 <h1 className="text-sm">{card.title}</h1>
...
//           <div
//             key={show._id}
//             className="w-56 rounded-lg overflow-hidden pb-3 h-full
...
//                 <StarIcon className="w-4 h-4 text-white fill-yellow" />
//                 {show.movie?.vote_average?.toFixed(1)}
//               </p>
//             </div>
