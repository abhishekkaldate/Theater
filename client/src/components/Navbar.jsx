  ...
  return (
    <div className='fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5'>
      ...
      <div className='flex items-center gap-8'>
        ...
        {
          !user ? (
        <button onClick={openSignIn} className='px-4 py-1 sm:px-7 sm:py-2 bg-gray hover:bg-gray-500 transition rounded-full font-medium cursor-pointer'>Login</button>
          ) : (
            <UserButton>
