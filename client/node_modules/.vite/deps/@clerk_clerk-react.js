...
var ClerkError = class ClerkError$1 extends Error {
	...
	constructor(opts) {
		...
		Object.setPrototypeOf(this, ClerkError$1.prototype);
		this.code = opts.code;
...
var ClerkAPIResponseError = class ClerkAPIResponseError$1 extends ClerkError {
	...
	constructor(message, options) {
		...
		Object.setPrototypeOf(this, ClerkAPIResponseError$1.prototype);
		this.status = status;
...
*/
var ClerkRuntimeError = class ClerkRuntimeError$1 extends ClerkError {
	...
	*/
	...
	constructor(message, options) {
		...
		Object.setPrototypeOf(this, ClerkRuntimeError$1.prototype);
	}
};
/**
...
* @internal
*/
var resolveAuthState = ({ authObject: { sessionId, sessionStatus, userId, actor, orgId, orgRole, orgSlug, signOut, getToken, has: has$2, sessionClaims }, options: { treatPendingAsSignedOut = true } }) => {
...
var require_use_sync_external_store_shim_development = /* @__PURE__ */ __commonJS({ "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js": ((exports) => {
	(function() {
		...
		function useSyncExternalStore$2$1(subscribe, getSnapshot) {
			didWarnOld18Alpha || void 0 === React$9.startTransition || (didWarnOld18Alpha = !0, console.error("You are using an outdated, pre-release alpha of React 18 that does not support useSyncExternalStore. The use-sync-external-store shim will not work correctly. Upgrade to a newer pre-release."));
		...
		var React$9 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState$3 = React$9.useState, useEffect$3 = React$9.useEffect, useLayoutEffect$1 = React$9.useLayoutEffect, useDebugValue$1 = React$9.useDebugValue, didWarnOld18Alpha = !1, didWarnUncachedGetSnapshot = !1, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1$1 : useSyncExternalStore$2$1;
		exports.useSyncExternalStore = void 0 !== React$9.useSyncExternalStore ? React$9.useSyncExternalStore : shim;
...
//#endregion
//#region node_modules/swr/dist/_internal/events.mjs
	...
	async function mutateByKey(_k) {
		...
		const startRevalidate = () => {
			...
			if (isFunction(options.revalidate) ? options.revalidate(get().data, _k) : options.revalidate !== false) {
				delete FETCH[key];
				delete PRELOAD[key];
				if (revalidators && revalidators[0]) return revalidators[0](MUTATE_EVENT).then(() => get().data);
			}
			return get().data;
		};
...
var middleware = (useSWRNext) => (key_, fetcher_, config) => {
	return useSWRNext(key_, fetcher_ && ((...args) => {
		...
		if (key.startsWith(INFINITE_PREFIX)) return fetcher_(...args);
...
var useSWRHandler = (_key, fetcher, config) => {
	const { cache: cache$1, compare: compare$1, suspense, fallbackData, revalidateOnMount, revalidateIfStale, refreshInterval, refreshWhenHidden, refreshWhenOffline, keepPreviousData } = config;
	const [EVENT_REVALIDATORS, MUTATION, FETCH, PRELOAD] = SWRGlobalState.get(cache$1);
	...
	const cached = (0, import_shim$1.useSyncExternalStore)((0, import_react.useCallback)((callback) => subscribeCache(key, (current, prev) => {
		if (!isEqual$1(prev, current)) callback();
				...
				if (shouldStartNewRequest && callbackSafeguard()) {
					...
					if (shouldRetryOnError === true || isFunction(shouldRetryOnError) && shouldRetryOnError(err)) {
						if (!getConfig().revalidateOnFocus || !getConfig().revalidateOnReconnect || isActive()) currentConfig.onErrorRetry(err, key, currentConfig, (_opts) => {
							const revalidators = EVENT_REVALIDATORS[key];
							if (revalidators && revalidators[0]) revalidators[0](ERROR_REVALIDATE_EVENT, _opts);
						}, {
	...
	useIsomorphicLayoutEffect(() => {
		...
		const onRevalidate = (type, opts = {}) => {
			...
			} else if (type == MUTATE_EVENT) return revalidate();
			else if (type == ERROR_REVALIDATE_EVENT) return revalidate(opts);
		};
	...
	if (suspense && isUndefined(data) && key) {
		...
		unmountedRef.current = false;
		const req = PRELOAD[key];
		if (!isUndefined(req)) use(boundMutate(req));
...
var OptionsContext = import_react.createContext({});
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/chunk-OT5FTIRN.mjs
...
function useDerivedAuth(authObject, { treatPendingAsSignedOut = true } = {}) {
	const { userId, orgId, orgRole, has: has$2, signOut, getToken, orgPermissions, factorVerificationAge, sessionClaims } = authObject != null ? authObject : {};
	const derivedHas = (0, import_react.useCallback)((params) => {
		if (has$2) return has$2(params);
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/chunk-VMBS36YX.mjs
...
//#endregion
//#region node_modules/@clerk/clerk-react/dist/chunk-6WD75OPE.mjs
...
var createAwaitableMutationObserver = (globalOptions) => {
	...
	return (options) => new Promise((resolve, reject) => {
		...
		const observer = new MutationObserver((mutationsList) => {
			for (const mutation$1 of mutationsList) {
				if (!elementToWatch && selector) elementToWatch = root == null ? void 0 : root.querySelector(selector);
				if (globalOptions.childList && mutation$1.type === "childList" || globalOptions.attributes && mutation$1.type === "attributes") {
					if (isReady(elementToWatch, selector)) {
						observer.disconnect();
						resolve();
						return;
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/versionSelector-KmjfH7w2.mjs
/**
...
//#endregion
//#region node_modules/@clerk/shared/dist/runtime/loadClerkJsScript-B6NtfI8g.mjs
...
var _IsomorphicClerk = class _IsomorphicClerk$1 {
	constructor(options) {
		...
		*/
		...
		this.__internal_attemptToEnableEnvironmentSetting = (options$1) => {
			const callback = () => {
				var _a;
				return (_a = this.clerkjs) == null ? void 0 : _a.__internal_attemptToEnableEnvironmentSetting(options$1);
			};
			if (this.clerkjs && this.loaded) return callback();
	...
	static getOrCreateInstance(options) {
		if (!inBrowser() || !__privateGet(this, _instance) || options.Clerk && __privateGet(this, _instance).Clerk !== options.Clerk || __privateGet(this, _instance).publishableKey !== options.publishableKey) __privateSet(this, _instance, new _IsomorphicClerk$1(options));
...
function ClerkProviderBase(props) {
	...
	if (!userInitialisedClerk && !__internal_bypassMissingPublishableKey) {
		if (!publishableKey) errorThrower.throwMissingPublishableKeyError();
		else if (publishableKey && !isPublishableKey(publishableKey)) errorThrower.throwInvalidPublishableKeyError({ key: publishableKey });
	}
